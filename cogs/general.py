...
class General(commands.Cog, name="general"):
    ...
    async def approve(self, context, user: discord.Member = None):
        """
    ...
    @approve.error
    async def approve_error(self, context, error):
    ...
    async def invite(self, context):
        ...
        """
        inv: discord.Invite = await context.channel.create_invite(max_age = 604800, max_uses = 1, reason = f"Generated by by {context.message.author}")
